...
const ModalConfirm = (props) => {
    ...
    const minusApetizers = (indexOfItem) => {
        ...
        if (newApetizers[indexOfItem].count > 1) newApetizers[indexOfItem].count = newApetizers[indexOfItem].count - 1;
    ...
    const minusDrinks = (indexOfItem) => {
        ...
        if (newDrinks[indexOfItem].count > 1) newDrinks[indexOfItem].count = newDrinks[indexOfItem].count - 1;
                        ...
                        return <div>
                            <div className="itemRow">
                                <div className="itemSelector">
                                    ...
                                    <button className="whiteButton" onClick={() => onChangeCourseMeals(indexOfItem)}>
                                        change
                                    </button>
                                </div>
                                <div className="itemCount">
                                    <div style={{ fontSize: "20px", paddingRight: "20px", paddingLeft: "20px" }}>{item.count}</div>
                                    <button className="plusButton" onClick={() => plusCourse(indexOfItem)}>
                                        +
                                    </button>
                                    <button className="minusButton" onClick={() => minusCourse(indexOfItem)}>
                                        -
                                    </button>
                                </div>
                            </div>
                            <div className="dropdownFood">
                                {item.change && foodData.map(item => {
                                    return <div
                                        ...
                                        onClick={() => selectNewCourseMeal(indexOfItem, item.id)}
                                    >
                                        {item.item}
                                    </div>
                                })}
                        ...
                        return <div>
                            <div className="itemRow">
                                <div className="itemSelector">
                                    ...
                                    <button className="whiteButton" onClick={() => onChangeApetizers(indexOfItem)}>
                                        change
                                    </button>
                                </div>
                                <div className="itemCount">
                                    <div style={{ fontSize: "20px", paddingRight: "20px", paddingLeft: "20px" }}>{item.count}</div>
                                    <button className="plusButton" onClick={() => plusApetizers(indexOfItem)}>
                                        +
                                    </button>
                                    <button className="minusButton" onClick={() => minusApetizers(indexOfItem)}>
                                        -
                                    </button>
                                </div>
                            </div>
                            <div className="dropdownFood">
                                {item.change && apetizerData.map(item => {
                                    return <div
                                        className="itemSelectorFood"
                                        style={{ fontSize: "20px", paddingLeft: "20px" }}
                                        onClick={() => selectNewApetizers(indexOfItem, item.id)}
                                    >
                                        {item.item}
                                    </div>
                                })}
                        ...
                        return <div>
                            <div className="itemRow">
                                <div className="itemSelector">
                                    ...
                                    <button className="whiteButton" onClick={() => onChangeDrinks(indexOfItem)}>
                                        change
                                    </button>
                                </div>
                                <div className="itemCount">
                                    <div style={{ fontSize: "20px", paddingRight: "20px", paddingLeft: "20px" }}>{item.count}</div>
                                    <button className="plusButton" onClick={() => plusDrinks(indexOfItem)}>
                                        +
                                    </button>
                                    <button className="minusButton" onClick={() => minusDrinks(indexOfItem)}>
                                        -
                                    </button>
                                </div>
                            </div>
                            <div className="dropdownFood">
                                {item.change && drinkData.map(item => {
                                    return <div
                                        className="itemSelectorFood"
                                        style={{ fontSize: "20px", paddingLeft: "20px" }}
                ...
                <div className="suvRow">
                    ...
                    <div>
                        ...
                        <div className="rowLabel">
                            ...
                            <div className="itemCount">
                                <div style={{ fontSize: "20px", paddingRight: "20px", paddingLeft: "20px" }}>{shirtCount}</div>
                ...
                <div className="suvRow">
                    ...
                    <div>
                        ...
                        <div className="rowLabel">
                            ...
                            <div className="itemCount">
                                <div style={{ fontSize: "20px", paddingRight: "20px", paddingLeft: "20px" }}>{cupCount}</div>
